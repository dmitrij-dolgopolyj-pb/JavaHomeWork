...
public class NumBox<T extends Number>
{
    ...
    //Создадим метод, выводящий на экран всю необходимую информацию о классе
    void classInfo()
    {
        int arrayDepth= this.length();
        System.out.println("В массиве класса находятся "+arrayDepth+" элемента(ов):");
        for (int i=0; i<arrayDepth;i++)
        {
            System.out.println("T["+i+"]="+this.get(i));
        }
        System.out.println("Cумма всех элементов массива равна:"+this.sum());
        System.out.println("Cреднее арифметическое массива равно:"+this.average());
        System.out.println("Максимальный элемент массива это:"+this.max());
    }
}
